...
>>> (fst *** fst) $ bounds euler13Array
(1,100)
-}
euler13Array :: Array (Int, Int) Integer
euler13Array = listArray ((1, 1), (100, 50)) euler13Data

{-
>>> take 3 euler13Nums
[135740250,7018260538,6617309629]
-}
euler13Nums :: [Integer]
euler13Nums = [numFromList [euler13Array ! (i, j) | j <- [b..(b + 10)]] | i <- [a..c]]
    where ((a, b), (c, d)) = bounds euler13Array
...
-}
euler13 :: Integer
euler13 = numFromList . take 10 $ full
    where
        full = listFromNum . sum $ euler13Nums
        l = length full
